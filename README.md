...
**Ante Apocalypse**는 Babylon.js와 WebGL 기술을 활용하여 웹 브라우저에서 바로 즐길 수 있는 FPS 게임입니다. 현재 버전은 **사격장(Shooting Range) 프로토타입**으로, 기본적인 이동과 사격 메커니즘을 체험할 수 있습니다.
...
- **Language**: TypeScript
- **Bundler**: Vite
- **Physics**: Babylon.js Built-in Collision & Havok Physics (예정)
